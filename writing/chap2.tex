...
explainable AI (XAI). Section\,2.1 introduces DGA and key gases (Hâ‚‚,
CHâ‚„, Câ‚‚Hâ‚†, Câ‚‚Hâ‚„, Câ‚‚Hâ‚‚, CO, COâ‚‚) used to diagnose incipient faults.
...
hydrogen (Hâ‚‚), methane (CHâ‚„), ethane (Câ‚‚Hâ‚†), ethylene (Câ‚‚Hâ‚„), acetylene
(Câ‚‚Hâ‚‚), and the byproducts carbon monoxide (CO) and carbon dioxide
(COâ‚‚). IEEE C57.104â€‘2019 and IEC 60599:2022 codify how these gas levels
...
\textbf{Rogers} ratio methods calculate fixed gas ratios (e.g.~CHâ‚„/Hâ‚‚,
Câ‚‚Hâ‚‚/CHâ‚„, Câ‚‚Hâ‚„/Câ‚‚Hâ‚†, etc.) to map to fault regions. The \textbf{IEC
ratio method} \parencite{IEC60599} uses a subset of the Rogers ratios (omitting
Câ‚‚Hâ‚†/CHâ‚„) to distinguish low- vs.~high-temperature thermal faults.
\textbf{Duval's triangle} uses the three hydrocarbon gases CHâ‚„, Câ‚‚Hâ‚„,
Câ‚‚Hâ‚‚ on a triangular plot to classify faults, while \textbf{Duval's
pentagon} extends this by including Hâ‚‚ and Câ‚‚Hâ‚† to better differentiate
...
\bottomrule\noalign{}
\endlastfoot
Key Gas & Single highest-concentration gas (Hâ‚‚, CHâ‚„, Câ‚‚Hâ‚†, Câ‚‚Hâ‚„, Câ‚‚Hâ‚‚,
CO, COÃ¢â€šâ€š) & Predominant fault gas type\newline (thermal vs.~electrical) & Always
yields a classification (simple) & High misdiagnosis rate (\(\approx\)30--50\%);
ignores mixed faults \\
Dornenburg Ratio & CHÃ¢â€šâ€ž/CÃ¢â€šâ€šHÃ¢â€šâ€ž, CHÃ¢â€šâ€ž/CÃ¢â€šâ€šHÃ¢â€šâ€š, CÃ¢â€šâ€šHÃ¢â€šâ€š/CÃ¢â€šâ€šHÃ¢â€šâ€ž & Broad thermal\newline
vs.~discharge & Accounts for gas ratios & Over-simplified; uses fixed
thresholds \\
Rogers Ratio & CHâ‚„/Hâ‚‚, Câ‚‚Hâ‚†/CHâ‚„, Câ‚‚Hâ‚„/Câ‚‚Hâ‚†, Câ‚‚Hâ‚‚/Câ‚‚Hâ‚„ & Detailed thermal
(low/high) and PD & More fault categories than Key Gas & Inconsistent
when gases out-of-range; ignores aging \\
IEC Ratio (60599) & CHâ‚„/Hâ‚‚, Câ‚‚Hâ‚‚/CHâ‚„, Câ‚‚Hâ‚‚/Câ‚‚Hâ‚„ & Low- vs.~high-energy
faults, PD & Standardized in IEC {[}IEC 60599:2022{]} & Cannot subtype
within categories; excludes Câ‚‚Hâ‚†/CHâ‚„ \\
Duval Triangle & CHÃ¢â€šâ€ž, CÃ¢â€šâ€šHÃ¢â€šâ€ž, CÃ¢â€šâ€šHÃ¢â€šâ€š (triangular plot) & Six fault zones\newline
(PD, low \& high thermal/electrical) & Graphical; intuitive\newline
visualization & No ``normal'' region; requires user-set gas limits \\
Duval Pentagon (1,2) & Hâ‚‚, CHâ‚„, Câ‚‚Hâ‚†, Câ‚‚Hâ‚„, Câ‚‚Hâ‚‚ (five-point plot) &
...
noted, a complete DGA sample includes seven key gas features: Hâ‚‚, CHâ‚„,
Câ‚‚Hâ‚†, Câ‚‚Hâ‚„, Câ‚‚Hâ‚‚, CO, and COâ‚‚. (Other gases such as oxygen or nitrogen
...
the Rogers and IEC methods. Common ratio features include CHâ‚„/Hâ‚‚,
Câ‚‚Hâ‚†/CHâ‚„, Câ‚‚Hâ‚„/Câ‚‚Hâ‚†, Câ‚‚Hâ‚‚/Câ‚‚Hâ‚„, as well as Câ‚‚Hâ‚‚/Hâ‚‚ and COâ‚‚/CO (the
...
encodes ratios (since log(A/B)=log A -- log B). Thus, logâ€transformed
...
space by asking a sequence of threshold questions (e.g.~``CHâ‚„
...
internal node might split on CHâ‚„/Hâ‚‚ ratio to decide a thermal vs.~arcing
fault.\\
...
CHâ‚„/Hâ‚‚ \textgreater{} 0.2 AND Câ‚‚Hâ‚‚ \textgreater{} 5 ppm THEN
...
\bottomrule\noalign{}
\endlastfoot
Gas Concentrations & Hâ‚‚, CHâ‚„, Câ‚‚Hâ‚†, Câ‚‚Hâ‚„, Câ‚‚Hâ‚‚, CO, COâ‚‚ (ppm) & Direct
indicators of fault gases; used as raw input & Mirowski \& LeCun (2012)
; Suwarno et al. \\
Gas Ratios & CHâ‚„/Hâ‚‚, Câ‚‚Hâ‚†/CHâ‚„, Câ‚‚Hâ‚„/Câ‚‚Hâ‚†, Câ‚‚Hâ‚‚/Câ‚‚Hâ‚„ & Capture relative
gas patterns (e.g.~Rogers ratios) & Rogers (1978) method; Doernenburg
method \\
Combined/\\Derived & Log(HÃ¢â€šâ€š), TDCG (sum), gas\% of TDCG, normalized
...
usage of age) \\
Expanded Gas\\Ratios & CÃ¢â€šâ€šHÃ¢â€šâ€š/HÃ¢â€šâ€š, COÃ¢â€šâ€š/CO, OÃ¢â€šâ€š/NÃ¢â€šâ€š & Additional ratios to
detect leakage or cellulose aging & Hâ‚‚Scan (2024) guideâ€  \\
\end{longtable}\endgroup

\emph{In some studies, transformer operating data are included to
contextualize DGA.}\\
â€ Tutorial example (not peer-reviewed) showing COâ‚‚/CO, Oâ‚‚/Nâ‚‚ usage.
...
Câ‚‚Hâ‚‚ driving arcing predictions). Similarly, Udeh \emph{et al.} (2026)
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.1694}}
...
CHâ‚„/Câ‚‚Hâ‚‚ for arcing), but most moderate (incipient) faults had
...
(e.g.~Hâ‚‚ important for PD), confirming model reliability. (SHAP values
